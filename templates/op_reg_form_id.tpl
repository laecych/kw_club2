...
<form action="index.php" method="post" id="regForm" enctype="multipart/form-data" class="myForm " role="form">
        ...
        <div class="col-sm-10">
            ...
            <div class="form-check form-check-inline">   
                    ...
                    <{if $gname==$smarty.const._MD_KWCLUB_KG}>
                        <input type='radio' name='reg_grade' id="reg_grade<{$v}>" class="form-check-input validate[required]" title='<{$smarty.const._MD_KWCLUB_KINDERGARTEN}>' value='<{$gname}>' <{if $gname == $reg_grade}>checked<{/if}>>
                        <label class="form-check-label" for="reg_grade<{$v}>"><{$smarty.const._MD_KWCLUB_KINDERGARTEN}></label>
                    <{else}>
                        <input type='radio' name='reg_grade' id="reg_grade<{$v}>" class="form-check-input validate[required]" title='<{$gname}><{$smarty.const._MD_KWCLUB_GRADE}>' value='<{$gname}>' <{if $gname == $reg_grade}>checked<{/if}>>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            <div class="form-check form-check-inline">
                <input type='radio' name='reg_class' id="reg_class<{$v}>" class="form-check-input validate[required]" title='<{$cname}>' value='<{$cname}>' <{if $cname == $reg_class}>checked<{/if}>>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" name="reg_number" id="reg_number" class="form-control validate[required]" value="<{$reg_number}>" placeholder="<{$smarty.const._MD_KWCLUB_KEYIN}><{$smarty.const._MD_KWCLUB_REG_NUMBER}>">
        </div>
    </div>
    <div class="form-group row">
        <!--家長姓名-->
