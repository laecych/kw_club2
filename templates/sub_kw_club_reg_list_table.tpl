        ...
        <{foreach from=$all_reg item=data}>
            <ul>
                ...
                <{if !$class_id}>
                    ...
                    <li class="vm w2">
                        <a href="index.php?class_id=<{$data.class_id}>" data-toggle="tooltip" data-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<{$data.class_id}>"><{$data.class_title}></a>
                    </li>
                <{/if}>
                ...
                <li class="vm w1 text-center">
                    ...
                    <{/if}>
                    <span <{if $smarty.session.isclubAdmin || $uid == $class_uid }>class="editable" id="reg_number_<{$data.reg_sn}><{/if}>"> <{$data.reg_number}></span>號
                </li>
                ...
                <{if $smarty.session.isclubAdmin || $uid == $class_uid }>
                    ...
                    <li class="vm text-center">
                        <a href="register.php?op=update_reg_isfee&amp;reg_isfee=<{if $data.reg_isfee==1}>0<{else}>1<{/if}>&amp;reg_sn=<{$data.reg_sn}>" data-toggle="tooltip" data-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<{$smarty.const._MD_KWCLUB_CLICK_TO}><{if $data.reg_isfee==1}><{$smarty.const._MD_KWCLUB_NOT_PAY}><{else}><{$smarty.const._MD_KWCLUB_PAID}><{/if}>"><{$data.reg_isfee_pic}></a>
                    ...
                    <!--功能-->
                    <li class="vm w1 text-center">
                        <a href="index.php?reg_uid=<{$data.reg_uid}>&op=myclass" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<{$smarty.const._MD_KWCLUB_SIGNUP_STATUS|sprintf:$data.reg_datetime:$data.reg_ip:$data.reg_sn}>"><{$smarty.const._MD_KWCLUB_DETIAL}></a>
                        <{if !$data.reg_isfee}>
