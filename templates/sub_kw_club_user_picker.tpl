...
<div class="row">
    ...
    <div class="col-sm-1 text-center mt-5 pt-5">
        <img src="<{$xoops_url}>/modules/kw_club/assets/images/right.png" onclick="tmt.spry.linkedselect.util.moveOptions('adm_repository', 'adm_destination');getOptions('adm_destination','admins_uid');"><br>
        <img src="<{$xoops_url}>/modules/kw_club/assets/images/left.png" onclick="tmt.spry.linkedselect.util.moveOptions('adm_destination' , 'adm_repository');getOptions('adm_destination','admins_uid');"><br><br>

        <!-- <img src="<{$xoops_url}>/modules/kw_club/assets/images/up.png" onclick="tmt.spry.linkedselect.util.moveOptionUp('adm_destination');getOptions('adm_destination','admins_uid');"><br>
        <img src="<{$xoops_url}>/modules/kw_club/assets/images/down.png" onclick="tmt.spry.linkedselect.util.moveOptionDown('adm_destination');getOptions('adm_destination','admins_uid');">-->
    </div>
    <div class="col-sm-5">
...
<input type="hidden" name="admins_uid" id="admins_uid" value="">
