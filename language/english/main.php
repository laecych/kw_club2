...
define('_MD_KWCLUB_MANAGER_SETUP', 'Admin setup');
...
define('_MD_KWCLUB_NUMBER', 'number');
...
define('_MD_KWCLUB_C', 'Class');
define('_MD_KWCLUB_OPENID', 'OPEN_ID');
...
define('_MD_KWCLUB_NEED_TYPE', 'Error! Type is wring');
...
define('_MD_KWCLUB_LOGIN_APPLY_DESC', '(The unit tad_login module must be installed, students login by openID.)');
define('_MD_KWCLUB_NEED_OPENID', 'Please login by openID!');
define('_MD_KWCLUB_NEED_CODE', 'No School code，Please notify to administrator!');
define('_MD_KWCLUB_NOT_SCHOOL', 'non-school students!');
define('_MD_KWCLUB_TEACHER_UPLOAD', 'Teacher Data');
...
define('_MD_KWCLUB_CLASS_SETUP', 'Set up Class');
define('_MD_KWCLUB_CLASS_LIST', 'Class list');
define('_MA_KWCLUB_ADMIN_SETUP', 'Admin setup');
...
define('_MD_KWCLUB_NON_REGISTRATION_TIME', 'Non-registration time');
...
define('_MD_KWCLUB_REG_NUMBER', 'Student number');
define('_MD_KWCLUB_REG_PARENT', ' Parent Name');
define('_MD_KWCLUB_REG_TEL', ' Phone Number');
define('_MD_KWCLUB_LANGUAGE', 'Chinese');

define('_MD_KWCLUB_ISSHOW', 'Registration reulst');
define('_MD_KWCLUB_ISSHOW_YES', 'Display');
define('_MD_KWCLUB_ISSHOW_NO', 'No display');
define('_MD_KWCLUB_ISSHOW_DESC', 'It will display the result finally after the end of registration date!');
define('_MD_KWCLUB_ADD', 'Add');
define('_MD_KWCLUB_GRADE_ERROR', 'Error! Wrong grade');
