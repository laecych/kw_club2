...
define('_MD_KWCLUB_TEACHER_ID', '上課講師');
...
define('_MD_KWCLUB_NEED_TYPE', '錯誤！需要類別型態!');
...
define('_MD_KWCLUB_OFFICIALLY_WAITE', '待確認');
...
define('_MD_KWCLUB_ISSHOW', '報名結果');
define('_MD_KWCLUB_ISSHOW_YES', '顯示正備取');
define('_MD_KWCLUB_ISSHOW_NO', '不顯示');
define('_MD_KWCLUB_ISSHOW_DESC', '將於報名截止日後，自動顯示最後錄取結果!');
define('_MD_KWCLUB_NUMBER', '座號');
...
define('_MD_KWCLUB_C', '班');
define('_MD_KWCLUB_OPENID', '學生OPEN_ID');
...
define('_MD_KWCLUB_LOGIN_APPLY_DESC', '（openID報名，需安裝tad_login模組）');
define('_MD_KWCLUB_NEED_OPENID', '請登入OPENID報名');
define('_MD_KWCLUB_NEED_CODE', '學校代碼未填，請聯繫資訊組長填寫!');
define('_MD_KWCLUB_NOT_SCHOOL', '非本校學生或是登入資料錯誤!');
...
define('_MD_KWCLUB_CLASS_SETUP', '社團排序設定');
define('_MD_KWCLUB_CLASS_LIST', '社團排序列表');
define('_MD_KWCLUB_MANAGER_SETUP', '社團管理設定');
define('_MA_KWCLUB_ADMIN_SETUP', '社團管理設定');

define('_MD_KWCLUB_TEACHER_SETUP', '開課教師設定');
define('_MD_KWCLUB_TEACHER_LIST', '教師列表');
define('_MD_KWCLUB_TEACHER_UPLOAD', '相關資料');
...
define('_MD_KWCLUB_NOT_FOUND', '查無任何 %s 的報名資料');
