...
define('_MI_KWCLUB_SHOW_BLOCK_DESC', '社團報名系統區塊 (kw_club_show)');
...
define('_MI_KWCLUB_SCHOOL_CODE', '學校代碼設定');
define('_MI_KWCLUB_SCHOOL_CODE_DESC', '請務必填寫學校代碼!否則無法使用openID報名');
define('_MI_KWCLUB_SCHOOL_CODE_DEFAULT', '學校代碼');
