...
define('_MI_KWCLUB_SCHOOL_CODE', 'School code setting');
define('_MI_KWCLUB_SCHOOL_CODE_DESC', 'School code should be set up! Or students are not allowed to login by openID.');
define('_MI_KWCLUB_SCHOOL_CODE_DEFAULT', 'School code');


define('_MI_KWCLUB_SETUP_TEACHER', 'Club teacher setting');
define('_MI_KWCLUB_SCHOOL_GRADE', 'Set up grade');
define('_MI_KWCLUB_SCHOOL_GRADE_DESC', 'Set the grade that the student can register');
