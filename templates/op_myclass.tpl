...
<{if $reg_uid}>
    <{if $reg_name}>
    <h3>
        <div class="col"><span style="color: rgb(124, 58, 58);"><{$reg_name}></span>
            <a href="index.php?club_year=<{$club_year}>" tilte="返回<{$club_year}>"><span class="club_year_text"><{$club_year}></span></a><{$smarty.const._MD_KWCLUB_MY_ALL_CLASS}>
        
         <{if $club_info.club_isfree==1}>
         <span class="badge badge-success bg-success"><{$smarty.const._MD_KWCLUB_FREE_APPLY}> </span> 
                ...
                <ul>
                    ...
                    <li class="vm w1 text-center">
                        <{if $data.club_isshow==0}>
                            ...
                            <{/if}>
                        <{else}>
                            <span style='color: rgb(6, 2, 238)'><{$smarty.const._MD_KWCLUB_OFFICIALLY_WAITE}></span>
                        <{/if}>
                    </li>
                    ...
                    <{if !($today > $data.end_date) && !$data.reg_isfee}>
                        <a href="javascript:delete_reg_func(<{$data.reg_sn}>);" class="btn btn-danger btn-xs" <{if !$can_operate}>data-toggle="tooltip" data-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<{$smarty.const._MD_KWCLUB_OVER_END_TIME}>" disabled<{/if}>><i class="fa fa-times-circle" aria-hidden="true"></i>
                        <{$smarty.const._MD_KWCLUB_DELETE_APPLY}></a>
                    <{else}>
                        <a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<{$smarty.const._MD_KWCLUB_OVER_END_TIME}>" disabled><i class="fa fa-times-circle" aria-hidden="true"></i>
    ...
    <{else}>
        <div class="alert alert-danger">
           <{$smarty.const._MD_KWCLUB_NOT_FOUND|sprintf:$reg_uid}></div>
    <{/if}>
<{/if}>
