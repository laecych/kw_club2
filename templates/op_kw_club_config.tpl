<div id="setupTab">
    <ul class="resp-tabs-list vert">
        ...
        <li><{$smarty.const._MD_KWCLUB_CLASS_SETUP}></li>
        <li><{$smarty.const._MD_KWCLUB_MANAGER_SETUP}></li>
    </ul>
    ...
    <div class="resp-tabs-container vert">
        ...
        <div><{includeq file="$xoops_rootpath/modules/kw_club/templates/sub_kw_club_class.tpl"}></div>
        <div><{includeq file="$xoops_rootpath/modules/kw_club/templates/sub_kw_club_admin.tpl"}></div>
    </div>
</div>
